...
<p class="step-indent">Where,</p>
<p class="equation">$y =$ dependent variable at each hour for a full year, the value being projected ($Q_2$ and $Q_3$)</p>
<p class="equation">$x =$ independent variable at each hour for a full year, the supply fan motor energy consumption</p>
<p class="equation">$a,b,c,d =$ cubic relationship coefficients</p>

With this formula, the air flow rate Q2 and Q3 can be projected for the full year by plugging in values for x, the supply fan motor power draw.
...
<p class="step-indent">Where,</p>
<p class="equation">$y =$ dependent variable at each hour for a full year, the value being projected (sensible and latent effectiveness)</p>
